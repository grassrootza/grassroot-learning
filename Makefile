...
train-core:
	...
	cd ./core-platform; python3 -m rasa_core.train -d actions_domain.yml -s data/core -o models/dialogue --history 15 --nlu_threshold 0.0 --core_threshold 0.0 --fallback_action action_default_fallback
